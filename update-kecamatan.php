...
if (isset($_POST['tambah-data'])) {
    update_data_kecamatan($_POST);
}

$data = ambil_kecamatan_by_id($_GET['id']);
                ...
                <div class="card card-body w-100 mt-5">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama" placeholder="input nama kecamatan" id="nama" required value="<?= $data['nama']?>">
                        </div>
                        <div class="form-group">
                            <label for="deskripsi" class="form-label">Deskripsi <sup class="text-danger">*</sup></label>
                            <input type="text" class="form-control" name="deskripsi" placeholder="input deskripsi" id="deskripsi" required value="<?= $data['deskripsi']?>">
                        </div>
                        <div class="form-group">
                            <label for="polygon" class="form-label">Polygon Kecamatan <sup class="text-danger">*</sup></label>
                            <textarea name="polygon" id="polygon" cols="30" rows="10" class="form-control" required><?= $data['polygon']?></textarea>
                        </div>
                        <div class="btn-group">
