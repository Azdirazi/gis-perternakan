...
if (isset($_POST['tambah-data'])) {
    update_data_ternak($_POST);
}

$data = ambil_ternak_by_id($_GET['id']);
                ...
                <div class="card card-body w-100 mt-5">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ternak" placeholder="input ternak" id="ternak" required value="<?= $data['nama']?>">
                        </div>
                        <div class="form-group">
